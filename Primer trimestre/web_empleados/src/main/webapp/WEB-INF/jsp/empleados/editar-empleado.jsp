...
<div id="contenedora" style="float:none; margin: 0 auto;width: 900px;">
    <form action="${pageContext.request.contextPath}/gestion/empleado/editar/" method="post">
        ...
        <div style="margin-top: 6px;" class="clearfix">
            ...
            <div style="float: none;width: auto;overflow: hidden;">
                <input name="codigo_departamento" value="<%= optEmp.get().getCodigo_departamento() %>" readonly="readonly"/>
            </div>
        </div>
